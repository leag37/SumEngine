...
Vector VectorGreaterThan(const Vector v1, const Vector v2);
Vector VectorGreaterThanEqual(const Vector v1, const Vector v2);
Vector VectorLessThan(const Vector v1, const Vector v2);
Vector VectorLessThanEqual(const Vector v1, const Vector v2);
SUINT VectorMoveMask(const Vector v);
